...
def test_alias_creation_shows_copyable_success_dialog(page: Page, base_url: str) -> None:
    ...
    create_dialog.locator('input[name="description"]').fill("Issue 110")
    create_dialog.locator('label.mode-option:has(input[value="custom"])').click()
    create_dialog.locator('input[name="local_part"]').fill("issue-110")
